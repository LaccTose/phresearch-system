    ...
    <div class="container mx-auto p-6">
        <form action="{{ route('umsc.store') }}" method="POST" id="umscForm" class="bg-white p-6 rounded-2xl shadow-lg">
            ...
            <fieldset class="border-t-4 border-green-700 p-6 rounded-lg bg-white mb-8 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4"></div>
                <div>
                ...
                <!--ข้อมูลการให้บริการ 9/9/25 -->
                <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-y-6 lg:gap-x-6">
                    <!--allUser-->
                    <div class="col-span-1">
                        <label for="allUser" class="block text-base text-gray-700 mb-1">ผู้รับบริการทั้งหมด</label>
                    ...
                    <!--1.healthConsult-->
                    <div class="col-span-1">
                        <label for="healthConsultPeople" class="block text-base text-gray-700 mb-1">1.
                    ...
                    <!--2.serviceAdvice-->
                    <div class="col-span-1">
                        <label for="serviceAdvicePeople" class="block text-base text-gray-700 mb-1">2.
                    ...
                    <!--3.appointment-->
                    <div class="col-span-1">
                        <label for="appointmentPeople" class="block text-base text-gray-700 mb-1">3.
                    ...
                    <!--4.referralCoord-->
                    <div class="col-span-1">
                        <label for="referralCoordPeople" class="block text-base text-gray-700 mb-1">4.
                    ...
                    <!--5.homeVisit-->
                    <div class="col-span-1">
                        <label for="homeVisitPeople" class="block text-base text-gray-700 mb-1">5.
                    ...
                    <!--6.disabilityCert-->
                    <div class="col-span-1">
                        <label for="disabilityCertPeople" class="block text-base text-gray-700 mb-1">6.
                    ...
                    <!--7.supportRequest-->
                    <div class="col-span-1">
                        <label for="supportRequestPeople" class="block text-base text-gray-700 mb-1">7.
                    ...
                    <!--8.Telehealth-->
                    <div class="col-span-1">
                        <label for="telehealthPeople" class="block text-base text-gray-700 mb-1">8.
                            Telehealth</label>
                        <div class="flex gap-2">
            ...
            <fieldset class="border-t-4 border-green-700 p-6 rounded-lg bg-white mb-8 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                    ...
                    <div class="col-span-1">
                        <label for="" class="block text-base font-bold text-red-500 mb-1">จำนวนการตอบกลับภายใน 30 นาที</label>
                        <input type="number" id="" name="" min="0" class="w-full p-2 border border-gray-300 rounded-md shadow-sm" placeholder="ครั้ง">
                    </div>
                </div>
            </fieldset>
